...
function Spinner({size = "sm"}) {
    ...
    return (
        <span
            className={cls(s, "inline-block rounded-full animate-spin border-2 border-[#195C51]/20 border-t-[#195C51]")}/>
    );
}
        ...
        <div className="space-y-3">
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div
                        className="max-h-[260px] overflow-y-auto space-y-0.5 border border-[#E2E8E6] rounded-xl p-1 bg-[#F9FBFA]">
                        {filtered.length === 0 && (
        ...
        <div className="min-h-screen bg-[#F4F6F5] text-[#111C1A]">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                ...
                <div className="mb-7">
                    ...
                    <p className="text-sm text-[#00000099]">Send and monitor push notifications across your user
                        base</p>
                </div>
...
function BroadcastForm({showToast}) {
    ...
    const handleSend = async () => {
        ...
        setForm({...emptyForm(), type: "broadcast"});
        setConfirmed(false);
    };
        ...
        <div className="space-y-5 max-w-2xl">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-sm text-[#4B5E5A]">
                    I confirm this should be sent to <span
                    className="text-[#195C51] font-semibold">all active users</span>
                </span>
            </label>
                ...
                <div className="bg-white border border-[#E2E8E6] rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="space-y-3 mt-3">
                        {[
                            ...
                            {
                                label: "Other",
                                value: stats.totalNotifications - stats.adminNotifications - stats.broadcastNotifications,
                                color: "slate"
                            },
                        ].map(row => {
                            ...
                            return (
                                <div key={row.label}>
                                    <div className="flex justify-between mb-1">
                                        ...
                                        <span
                                            className="text-xs text-[#00000099] tabular-nums">{row.value} · {pct}%</span>
                                    </div>
                    ...
                    <div className="space-y-3 mt-3">
                        {[
                            {label: "Sent today", value: stats.todayNotifications, icon: "◎"},
                            {
                                ...
                                value: stats.totalNotifications - stats.deletedNotifications,
                                icon: "◉"
                            },
            ...
            <div className="bg-white border border-[#E2E8E6] rounded-2xl overflow-hidden shadow-sm">
                {loading ? (
                    ...
                    <>
                        ...
                        <div
                            className="flex items-center justify-between px-6 py-3 border-t border-[#E2E8E6] bg-[#F9FBFA]">
