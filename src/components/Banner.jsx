            ...
            <div className={`flex md:flex-row flex-col gap-4 justify-between align-middle`}>
                <div className={`md:max-w-[40%] max-w-[90%] flex flex-col justify-center align-middle items-center`}>
                    <div className={`px-8 flex flex-col gap-3 pt-12 `}>
                        ...
                        <div className={`py-5`}>
                            <a href={`#`} className={`text-white active:scale-110 m-1 p-3 px-4 rounded-full font-medium bg-gradient-to-tr from-[#195C51] via-gray-900  to-[#195C51] hover:bg-gradient-to-tl hover:from-[#195C51] hover:via-gray-900 hover:to-[#195C51] `}>
                                Shop now
                            </a>
                            <a href={`#`} target="_blank" rel="noopener noreferrer" className="inline-block py-2 px-7 active:scale-110 text-base text-body-color font-medium hover:text-gray-700 transition ">
                              Read more →
                            </a>
                        </div>
                    </div>
